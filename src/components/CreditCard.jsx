...
function CreditCard() {
    ...
    return (
        ...
        <div>CreditCard
                    ...
                    <div class="flip">
                        <div class="front">
                            ...
                            <svg class="wave" viewBox="0 3.71 26.959 38.787" width="26.959" height="38.787" fill="white">
                                ...
                                <path d="M13.74 7.563c.231.039.442.164.594.343 3.508 4.059 5.625 9.371 5.625 15.157 0 5.785-2.113 11.097-5.625 15.156-.363.422-1.035.472-1.422.109-.422-.363-.472-1-.109-1.421 3.211-3.711 5.156-8.551 5.156-13.843 0-5.293-1.949-10.133-5.156-13.844-.27-.309-.324-.75-.141-1.114.188-.367.578-.582.985-.542h.093z"></path>
                            ...
                            <div class="card-holder">mr {user.firstName}, +{user.lastName}</div>
                            <div class="master">
            ...
            <div class="terms">
                <p>This card is property of ExoBank, Wonderland. Misuse is a criminal offence. If found, please return to ExoBank or to the nearest bank with the MasterCard logo.</p>
